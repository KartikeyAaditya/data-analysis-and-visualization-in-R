...
nig <- read_csv("https://github.com/KartikeyAaditya/data-analysis-and-visualization-in-R/blob/main/Metadata_Country_API_NY.GDP.PCAP.PP.CD_DS2_en_csv_v2_41.csv")
